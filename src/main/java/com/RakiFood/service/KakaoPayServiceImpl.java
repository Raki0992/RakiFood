...
*/
	...
	private HttpHeaders getHeaderInfo() {
		...
		headers.set("Authorization", "KakaoAK 3a2a54234ebd4d4861cf8da5532932c5");
 ...
 * Content-type: application/x-www-form-urlencoded;charset=utf-8
 */
	public ReadyResponse payReady(Long ord_code, String itemName, int quantity, String raki_id, int totalAmount) {
		...
		parameters.add("partner_user_id", raki_id); // 가맹점 회원 id, 최대 100자
	...
	public ApproveResponse payApprove(Long ord_code, String tid, String pgToken, String raki_id) {
		...
		parameters.add("partner_user_id", raki_id); // 가맹점 회원 id, 결제 준비 API 요청과 일치해야 함
