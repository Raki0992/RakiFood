  ...
  <div class="box-body">
    <div class="form-group row">
      <label for="raki_id" class="col-2">아이디</label>
        <div class="col-8">
      <input type="text" class="form-control" name = "raki_id" id="raki_id" placeholder="아이디 입력...">
        </div>
        <div class="col-2">
    ...
    <div class="form-group row">
      <label for="raki_password" class="col-2">비밀번호</label>
        <div class="col-10">
      <input type="password" class="form-control" name = "raki_password" id="raki_password" placeholder="비밀번호 입력...">
        </div>
    </div>

    <div class="form-group row">
      <label for="raki_password2" class="col-2">비밀번호 확인</label>
        <div class="col-10">
      <input type="password" class="form-control" id="raki_password2" placeholder="비밀번호 확인...">
        </div>
    </div>
    ...
    <div class="form-group row">
      <label for="raki_name" class="col-2">이름</label>
        <div class="col-10">
      <input type="text" class="form-control" name ="raki_name" id="raki_name" placeholder="이름 입력...">
        </div>
    </div>
    ...
    <div class="form-group row">
      <label for="raki_email" class="col-2">전자우편</label>
        <div class="col-8">
      <input type="email" class="form-control" name = "raki_email" id="raki_email" placeholder="전자우편입력...">
        </div>
        <div class="col-2">
    ...
    <div class="form-group row">
      <label for="sample2_postcode" class="col-2">우편번호</label>
        <div class="col-8">
      <input type="email" class="form-control" name = "raki_zipcode" id="sample2_postcode" placeholder="우편번호입력...">
        </div>
        <div class="col-2">
    ...
    <div class="form-group row">
      <label for="sample2_address" class="col-2">기본주소</label>
        <div class="col-10">
      <input type="text" class="form-control" name = "raki_addr" id="sample2_address" placeholder="기본주소입력...">
        </div>
    </div>
	...
	<div class="form-group row">
      <label for="sample2_detailAddress" class="col-2">상세주소</label>
        <div class="col-10">
      <input type="text" class="form-control" name = "raki_deaddr" id="sample2_detailAddress" placeholder="상세주소입력...">
    ...
    <div class="form-group row">
      <label for="raki_phone" class="col-2">전화번호</label>
        <div class="col-10">
      <input type="text" class="form-control" oninput="oninputPhone(this)" maxlength="14" name = "raki_phone" id="raki_phone" placeholder="전화번호입력...">
        </div>
    </div>
      ...
      // document.getElementById("idCheck");
        ...
        $("#mailAuth").click(function() {
          ...
          $.ajax({    // public ResponseEntity<String> authSend(EmailDTO dto, HttpSession session)
            ...
            data : {receiverMail : $("#raki_email").val()},
            success : function(result) {
              if(result == "success") {
        ...
        $("#btnJoin").click(function() {
          ...
          // 비밀번호 확인
          if($("#raki_password").val() != $("#raki_password2").val()) {
              alert("비밀번호 확인이 일치하지 않습니다.");
              $("#raki_password2").focus();
              return;
          }
